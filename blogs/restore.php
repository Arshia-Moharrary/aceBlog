...
if ($result["status"] !== "deleted") {
    echo error("Your blog isn't deleted");
    exit;
}
...
try {
    // Query
    $sql = "UPDATE blogs SET status = 'unpublished', published_date = NULL WHERE id = ?";
    ...
    echo success("Your blog restore successfully (Your blog moved in unpublished blogs)");
